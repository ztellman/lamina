...
Since we can have multiple consumers for any stream of data, we can easily analyze a stream without affecting other code.  Lamina provides a "rich set of operators":https://ztellman.github.com/lamina/lamina.stats.html for analyzing the data flowing through channels.
